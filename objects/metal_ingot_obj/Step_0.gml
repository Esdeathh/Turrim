if (place_meeting(x,y,player1)) && (player1.holding == false || Trzymany) && (keyboard_check_pressed(ord("Q")) && id != anvil_obj.item_real.id && id != tableL_obj.item_real.id && id != tableR_obj.item_real.id)
{
	Trzymany = !Trzymany;
...
if (Trzymany == true)
{
	...
	{
		Trzymany = false;
		physics_apply_impulse(phy_position_x,phy_position_y,300+player1.phy_speed_x*50,-300);
		player1.holding = false;
	}
}